...
#[Route('/financeadmin')]
final class FinanceAdminController extends AbstractController
{
    #[Route(name: 'app_finance_indexadmin', methods: ['GET'])]
    public function index(FinanceRepository $financeRepository): Response
    {
        return $this->render('finance/indexadmin.html.twig', [
